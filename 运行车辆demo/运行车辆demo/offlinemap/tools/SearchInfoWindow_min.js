    ...
    a.prototype.getOffset = function () {
        ...
        _closeOtherSearchInfo: function () {
            ...
            var j = parseInt(this._map.getContainer().offsetHeight, 10),
                o = parseInt(this._map.getContainer().offsetWidth, 10), k = this._boxHeight, e = this._boxWidth;
            if (k >= j || e >= o) {
                return
            }
            ...
            var l = this._unique(this._opts._searchTypes), f = this.dom.navTab,
                k = [this.dom.seartTab, this.dom.tohereTab, this.dom.fromhereTab], j = 0, e = 0, h = 0, m;
