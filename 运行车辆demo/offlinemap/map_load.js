...
(function(){
  ...
  //加载地图API主文件
    document.write('<script type="text/javascript" src="'+offmapcfg.home+'map_1.4.js?v=2.1"></script>');
  ...
  document.write('<script type="text/javascript" src="'+offmapcfg.home+'map_city.js?v=2.1"></script>');
    //加载路书document.write('<script type="text/javascript" src="'+offmapcfg.home+'tools/LuShu_min.js"></script>');
})();
